<form class="ms2_form" id="msOrder" method="post">
    <div class="row mb-5">
        ...
        <div class="col-12 col-md-6" id="payments">
            <h4 class="font-weight-semibold mb-5 bolder-title position-relative mt-5 mt-lg-0">{'ms2_comments_on_the_order' | lexicon}:</h4>
            <div class="form-group row input-parent">
                <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-12" id="deliveries">
            <h4 class="font-weight-semibold bolder-title position-relative mb-5">{'ms2_frontend_deliveries' | lexicon}:</h4>
            <div class="form-group row input-parent checkbox-horizontal">
                ...
                <div class="col-md-8 d-md-flex align-items-center">
                    <div class="form-check form-check-inline mr-3 ">
                        <input checked class="form-check-input" type="radio" name="region" id="delivery_moscow" value="Москва">
                        <label class="form-check-label" for="delivery_moscow">Москва</label>
                    </div>
                    <div class="form-check form-check-inline mr-3">
                        <input class="form-check-input" type="radio" name="region" id="delivery_spb" value="Санкт-Петербург">
                        <label class="form-check-label" for="delivery_spb">Санкт-Петербург</label>
                    </div>
                    <div class="form-check form-check-inline mr-3">
                        <input class="form-check-input" type="radio" name="region" id="delivery_ekb" value="Екатеринбург">
                        <label class="form-check-label" for="delivery_ekb">Екатеринбург</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="region" id="delivery_region" value="Другой регион">
            ...
            <div class="form-group row">
                <div class="col-12">
                    {foreach $deliveries as $delivery index=$index}
                        ...
                        <div class="checkbox py-3 px-4 border my-4" id="delivery_{$delivery.id}" style="{if $delivery.id == 1 OR $delivery.id == 3 OR $delivery.id == 5 OR $delivery.id == 7}display:none;{/if}">
                            <label class="col-form-label delivery input-parent">
                                <input type="radio" name="delivery" class="ez-radio" value="{$delivery.id}" id="delivery_{$delivery.id}"
    ...
    <div class="d-flex flex-column align-items-end justify-content-md-end mb-4">
        ...
        <button type="submit" name="ms2_action" value="order/submit" class="btn btn-lg btn-success ml-md-2 ms2_link col-md-3">
