...
$_lang['setting_ms2_product_as_uri_desc'] = 'Сформируйте URI карточки товара. Настройки вступят в силу при сохранении товара через CMS и импорте пакета ImportExport';

$_lang['setting_ms2_product_as_uri_debug'] = 'Лог изменения URL';
$_lang['setting_ms2_product_as_uri_debug_desc'] = 'Дебагер для отслеживания изменения URL при включенном плагине изменения URL товара';